...
function SectionTwo({ sectionData }) {
  ...
  return (
    <section
      className="flex flex-col md:flex-row w-full text-white bg-cover bg-center h-full md:h-[100vh] !px-6 !py-10"
        ...
        <>
          <div className="w-full h-[50%] md:h-full md:w-[50%] flex justify-center items-center order-2 md:order-1 mt-8 md:mt-0">
            ...
            <div className="relative flex items-center justify-center">
              <span className="absolute w-30 h-30 rounded-full border-4 border-white opacity-70 animate-signal"></span>
              <button
                className="w-30 h-30 relative rounded-full border border-white flex flex-col justify-center items-center text-white animate-pulse-scale"
